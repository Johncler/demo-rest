...
public class RegistroMascotaDao {
    ...
    public MascotaDto findMascotaDtoById(Integer mascoId){
        ...
        try (Connection cn = dataSource.getConnection();
             PreparedStatement pst = cn.prepareStatement("SELECT id_mascota,id_especie,id_raza,id_imagen,id_dueño,nombre_mascota,tamaño,color,sexo,fecha_registro FROM mascota WHERE id_mascota = ?");){
            pst.setInt(1,mascoId);
